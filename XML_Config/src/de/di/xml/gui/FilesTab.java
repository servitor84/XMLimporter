...
import de.di.xml.gui.importers.ELOImporter;
import de.di.xml.gui.importers.ExpertImporter;
import de.di.xml.gui.importers.Importer;
...
public class FilesTab extends javax.swing.JPanel implements ConfigTab {
    ...
    private LogLevel[] levelItems = new LogLevel[5];
    ...
    public FilesTab() {
        ...
        levelItems[0] = new LogLevel(Level.DEBUG, LogLevel.Type.DEBUG);
        ...
        levelItems[4] = new LogLevel(Level.ERROR, LogLevel.Type.ERROR);
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("de/di/xml/gui/resources/FilesTab"); // NOI18N
...
private void signalFileCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signalFileCheckBoxActionPerformed
    ...
    if (signalFileCheckBox.isSelected()) {
        config.setProperty(Property.ImporterCreateSignalFile, "TRUE");
    } else {
        config.setProperty(Property.ImporterCreateSignalFile, "FALSE");
    }
...
private void indexServerTextFieldCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_indexServerTextFieldCaretUpdate
    ...
    private void passwordTextFieldCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_passwordTextFieldCaretUpdate
        ...
        try {                
            ...
            fuzzy = des.encrypt(String.copyValueOf(passwordTextField.getPassword()));
            config.setProperty(Config.Property.IndexServerPassword, fuzzy); // String.copyValueOf(passwordTextField.getPassword())
        } catch (Exception ex) {}              
        // +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
//    recoveryLogFileSizeSpinner.setValue(i);
        ...
        for (i = 0; i < levelItems.length; i++) {
            ...
            if (logLevel.equals(levelItems[i].getLevel())) {
...
//        logFileCountComboBox.setSelectedItem(item);
        ...
        String importerClass = config.getProperty(Property.BasicImporter,
                "de.di.xml.gui.importers.ELOImporter");
...
//          1]);
        ...
        boolean checkSignalFile = Boolean.parseBoolean(
                config.getProperty(Property.ImporterCreateSignalFile, "TRUE"));

        signalFileCheckBox.setSelected(checkSignalFile);

        boolean checkDuplicates = Boolean.parseBoolean(
                config.getProperty(Property.ImporterCheckDuplicates, "FALSE"));
...
//                Config.Property.IndexServerPassword, "password"));
        // --- PWD decrypting if necessary
//        int pwdCharacters = 0;
//        String password = c.getProperty(Config.Property.IndexServerPassword, "password");
//        for(int pwdlength = 0; pwdlength < password.length(); pwdlength++)
//        {                    
//            if(Character.isDigit(password.charAt(i)) || password.valueOf(i).equals("-"))
//            {
//                pwdCharacters++;
//            }
//        }
        // Hit: password is encoded - have to be decoded
//        if(pwdCharacters == c.getProperty(Config.Property.IndexServerPassword, "password").length() && c.getProperty(Config.Property.IndexServerPassword, "password").contains("-"))
//        {
//            try {
